...
from Data_Validation.Validation import Validations
from Data_Transform.Transformation import Transform
from Data_Merge.Merge_Files import Merge
...
def trainRouteClient():
    ...
    transform.transformData(LocalTrainingPaths)
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|| Step 07 - Upload ||~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    aws = AWS(LocalTrainingPaths["LogFiles"], FileNames["Logs_Downloading_FileName"])
    aws.uploadAllFolders(LocalTrainingPaths, CloudTrainingPaths)
...
def PredictRoutClient():
    ...
    transform.transformData(LocalPredictingPaths)
